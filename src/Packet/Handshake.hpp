...
struct HandshakeM1
{
    ...
    HandshakeM1(std::vector<uint8_t>& ephemeral_key, int key_size, const unsigned char* username)
    {    
    ...
    static int GetSize() 
    {
        return sizeof(ephemeral_key_size) + sizeof(ephemeral_key) + sizeof(username);
    }
